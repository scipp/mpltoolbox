...
sciline_domain_types_prefix = 'mpltoolbox'
...
try:
    release = get_version("mpltoolbox")
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/mpltoolbox/",
...
htmlhelp_basename = 'mpltoolboxdoc'
